...
def players_pipeline():
    ...
    bash_task2 = BashOperator(
        ...
        bash_command='source /usr/local/airflow/dbt_venv/bin/activate && dbt run --project-dir /usr/local/airflow/include/dbt/ --profiles-dir /usr/local/airflow/include/dbt/',
    )
